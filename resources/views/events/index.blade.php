...
<div id="agenda" style="padding:15px;"></div>



@if (session('p_ocupado'))
<div class="alert alert-danger alert-dismissible fade show" role="alert">
  <strong>Alerta! </strong> {{ session('p_ocupado') }}
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
			<div class="d-none">
				...
				<input type="text" name="personal_information_id" id="personal_information_id" value="{{$id_up}}" readonly>
