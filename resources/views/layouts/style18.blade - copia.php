...
<head>
  ...
  <link href="{{ asset('css/style/style18.css') }}" rel="stylesheet">
...
<meta name="msapplication-TileImage" content="http://dcabecera.com/">    
<!-- fb & Whatsapp -->
...
<meta property="og:image" content="{{ asset('storage'). '/'.$personalInformation->favi2}}">
...
<meta property="og:url" content="http://dcabecera.com/">
