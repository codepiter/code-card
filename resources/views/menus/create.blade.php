...
<div class="row">
		<div class="col-xs-6 col-sm-6 col-md-6" style="margin-left:auto; margin-right:auto;">
				...
				<h5>Informacion Constante de su Restaurant <button type="button" class="btn btn-primary ayuda" data-toggle="modal" data-target="#modpag1" style="padding: 2px 8px;"><i class="fa fa-info-circle"></i></button></h5> 
						<!-- The Modal -->
