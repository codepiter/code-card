    ...
    <div class="card-body">
      ...
      <div class="container" id="banner">
        ...
        <div class="row">
          ...
          <h4>Informacion Constante de su Restaurant <button type="button" class="btn btn-primary ayuda" data-toggle="modal" data-target="#modpag1" style="padding: 2px 8px;"><i class="{{-- fa fa-info-circle --}} mdi mdi-information "></i></button></h4>
          </div>
