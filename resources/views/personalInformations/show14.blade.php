...
@endif
						  ...
						  <div class="profile-name">
							...
							@endif 
							   ...
							   <a href="{{ route('personalInformations.vcard',$personalInformation->id) }}" style="text-decoration:none;" class="msg-btnppl" target="_blank">Agregar al telefono</a>
