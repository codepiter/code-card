...
<div class="sfondo">
	...
	<div class="duo">
	<a href="{{ action('EventController@indexc', $personalInformation->id ) }}" class="msg-btnduo" style="text-decoration:none" target="_blank">Reunirnos</a>
	 ...
	 <div class="row multi-slider">
		<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
			...
			<div class="carousel-inner">
				...
				<a class="carousel-control-prev" href="#theCarousel3" role="button" data-slide="prev">
						<i class="fa fa-chevron-left fa-lg text-muted"></i>
						<span class="sr-only">Previous</span>
					</a>
					<a class="carousel-control-next text-faded" href="#theCarousel3" role="button" data-slide="next">
