      ...
      <div class="card-body">        
        ...
        <form action="{{ route('personalInformation.update',$personalInformation->id) }}" method="POST" enctype="multipart/form-data" id="myForm" style="font-family: Arial, Helvetica, sans-serif;background-color: #f0f8ff;">
          ...
          <div class="tab">
            ...
            <div style="font-size: large; text-align:center;">Ingrese imágenes segundo carousel <button type="button" class="btn btn-primary ayuda" data-toggle="modal" data-target="#modcar2" style="padding: 2px 8px;"><i class="{{-- fa fa-info-circle --}}mdi mdi-information"></i></button></div>
          ...
          <div class="tab current">
            ...
            <div class="row">
              <div class="col-xl-12 col-sm-12 col-md-12" style="text-align:center; margin-bottom: 15px;">
                <strong style="text-align: center;"><h4>Información de contacto</h4></strong>
              </div>
            </div>	
          ...
          <!--6 empresa-->
		  <div class="tab current">
            <div style="font-size: large; margin-bottom: 15px; text-align:center;"><h4>Ingrese las imágenes tercer carousel <button type="button" class="btn btn-primary ayuda" data-toggle="modal" data-target="#modcar3" style="padding: 2px 8px;"><i class="{{-- fa fa-info-circle --}}mdi mdi-information"></i></button></h4>  </div>
